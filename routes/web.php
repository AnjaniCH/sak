...
Route::group(['middleware'=>'auth'],function(){
	...
	Route::post('/presensi/edit','PresensiController@edit');
	Route::post('/organisasis','PresensiController@getOrg');
	Route::get('/presensi/delete/{id}','PresensiController@hapus');
	Route::post('/presensi/hapus_beberapa','PresensiController@hapusBeberapa');
	...
	Route::resource('/echarts', 'EchartController');
