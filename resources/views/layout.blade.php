...
<head>
  ...
  <link rel="stylesheet" href="{{url('')}}/plugins/components/css/components.min.css" type="text/css">
  <style type="text/css">
    .divider{
      width: 100%;
      height: 1px;
...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('')}}/echarts" class="nav-link">
              <i class="nav-icon fas fa-chevron-right"></i>
              <p>
                Chart
              </p>
  ...
  <footer class="main-footer">
    <strong>Anjani Chaerun Nisha</a></strong>
...
<!-- ./wrapper -->
<script type="text/javascript" src="{{url('')}}/plugins/echart/js/echarts.min.js"></script>	
<!-- jQuery -->
